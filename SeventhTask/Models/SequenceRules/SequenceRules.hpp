...
//const auto afterOne = GenRule<int, AfterOne>();
...
//const auto afterTwo = GenRule<int, AfterTwo>();
...
//const auto fibo = GenRule<int, Fibo>();
...
//const auto afterSqr = GenRule<int, AfterSqr>();
...
//const auto alwaysTrue = ValidRule<int, AlwaysTrue>();
...
//const auto alwaysFalse = ValidRule<int, AlwaysFalse>();
...
//const auto isOdd = ValidRule<int, IsOdd>();
...
//const auto isEven = ValidRule<int, IsEven>();
