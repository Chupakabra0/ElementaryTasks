...
namespace task::second {
    ...
    public:
        ...
        int operator()() const {
            std::string flag;
            do {
                std::unique_ptr<task::helpers::ConsoleInputValidator> consoleValidator
                ...
                std::unique_ptr<double> firstWidth = std::move(consoleValidator->LoopInput<double>
                        (positiveDouble));

                std::cout << "Creating second envelope." << std::endl << "Enter height:" << std::endl;
                std::unique_ptr<double> secondHeight = std::move(consoleValidator->LoopInput<double>
                        (positiveDouble));
                std::cout << "Enter width:" << std::endl;
                std::unique_ptr<double> secondWidth = std::move(consoleValidator->LoopInput<double>
                        (positiveDouble));
                ...
                std::unique_ptr<task::second::ViewModel> viewModel
                        (new(std::nothrow) task::second::ViewModel(firstEnvelope,
                                                                   secondEnvelope));
